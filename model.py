...
class Inception3(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=True, transform_input=False,
        ...
        self.self_attn2 = SelfAttentionModule(768)
        if aux_logits:
            self.AuxLogits = inception_aux(768, num_classes)
        self.Mixed_7a = inception_d(768)
        self.Mixed_7b = inception_e(1280)
        self.Mixed_7c = inception_e(2048)
        self.self_attn3 = SelfAttentionModule(2048)
    ...
    def _forward(self, x):
        ...
        return x, aux, attn_map

    @torch.jit.unused
    def eager_outputs(self, x, aux, attn_map):
    ...
    def forward(self, x):
        ...
        x, aux, attn_map = self._forward(x)
        aux_defined = self.training and self.aux_logits
        if torch.jit.is_scripting():
            ...
            return self.eager_outputs(x, aux, attn_map)
